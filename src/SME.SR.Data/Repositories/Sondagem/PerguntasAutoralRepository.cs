...
namespace SME.SR.Data
{
    public class PerguntasAutoralRepository : IPerguntasAutoralRepository
    {
        ...
        public async Task<IEnumerable<PerguntasOrdemGrupoAutoralDto>> ObterPerguntasPorGrupo(GrupoSondagemEnum grupoSondagem, ComponenteCurricularSondagemEnum componenteCurricular, int anoTurma)
        {
            StringBuilder query = new StringBuilder();
            ...
            query.Append(" inner join \"OrdemPergunta\" op on op.\"OrdemId\" = o.\"Id\"  ");
            query.Append(" inner join \"Pergunta\" p on p.\"Id\" = op.\"PerguntaId\" ");
            query.Append(" inner join \"PerguntaAnoEscolar\" pae on pae on pae.\"PerguntaId\" = p.\"Id\"  where 1=1 ");
            ...
            var parametros = new { anoTurma, grupoId = grupoSondagem.Name(), componenteCurricularId = componenteCurricular.Name() };
