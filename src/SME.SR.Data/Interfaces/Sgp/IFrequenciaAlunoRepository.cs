...
namespace SME.SR.Data.Interfaces
{
    public interface IFrequenciaAlunoRepository
    {
        ...
        Task<IEnumerable<FrequenciaAluno>> ObterFrequenciasPorTurmasAlunos(string[] codigosAluno, int anoLetivo, int modalidade, int semestre, string[] turmaCodigos, string professor = null);
