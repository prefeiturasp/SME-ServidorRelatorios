...
namespace SME.SR.Data.Interfaces
{
    public interface IAcompanhamentoAprendizagemRepository
    {
        ...
        Task<IEnumerable<AcompanhamentoTurmaAlunoImagemBase64Dto>> ObterInformacoesAcompanhamentoComImagemBase64TurmaAlunos(long turmaId,  int semestre, params string[] tagsImagensConsideradas);
    }
}