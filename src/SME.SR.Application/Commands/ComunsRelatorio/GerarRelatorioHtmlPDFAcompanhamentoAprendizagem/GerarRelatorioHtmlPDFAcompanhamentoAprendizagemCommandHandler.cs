...
{
    public class GerarRelatorioHtmlPDFAcompanhamentoAprendizagemCommandHandler : IRequestHandler<GerarRelatorioHtmlPDFAcompanhamentoAprendizagemCommand, string>
    {
        private readonly IConverter converter;
        private readonly IServicoFila servicoFila;
        private readonly IHtmlHelper htmlHelper;

        public GerarRelatorioHtmlPDFAcompanhamentoAprendizagemCommandHandler(IConverter converter,
        ...
        public async Task<string> Handle(GerarRelatorioHtmlPDFAcompanhamentoAprendizagemCommand request, CancellationToken cancellationToken)
        {
