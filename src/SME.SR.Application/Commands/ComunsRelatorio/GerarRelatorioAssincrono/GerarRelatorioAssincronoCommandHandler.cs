        ...
        {                       
            ...
            {                    
                ...
                if (exportacaoId != null)
                {
                    ...
                    var publicacaoFila = new PublicaFilaDto(dadosRelatorio, RotasRabbit.RotaRelatoriosProcessando, ExchangeRabbit.ExchangeListenerWorkerRelatorios, request.CodigoCorrelacao);
