...
namespace SME.SR.Application
{
    class ObterAusenciaPorAlunoTurmaBimestreQueryHandler : IRequestHandler<ObterAusenciaPorAlunoTurmaBimestreQuery, IEnumerable<AusenciaBimestreDto>>
    {
        ...
        {
            return frequenciaAlunoRepository.ObterAusenciaPorAlunoTurmaBimestre(request.AlunosCodigo,request.TurmaCodigo,request.Bimestre, request.ComponentesCurricularesIds);
        }
    }
}
