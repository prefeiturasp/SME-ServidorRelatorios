...
{
    class ObterAulasNormaisExcedidasQueryHandler : IRequestHandler<ObterAulasNormaisExcedidasQuery, IEnumerable<AulasNormaisExcedidoControleGradeSinteticoDto>>
    {
        ...
        public async Task<IEnumerable<AulasNormaisExcedidoControleGradeSinteticoDto>> Handle(ObterAulasNormaisExcedidasQuery request, CancellationToken cancellationToken)
