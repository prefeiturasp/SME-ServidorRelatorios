...
{
    public class RelatorioPaginadoHistoricoEscolarEJA : RelatorioPaginadoHistoricoEscolar<HistoricoEscolarEJADto>
    {
        public RelatorioPaginadoHistoricoEscolarEJA(IEnumerable<HistoricoEscolarEJADto> historicoEscolarDTOs) : base(historicoEscolarDTOs)
        {
            TabelaHistoricoTodosAnos = SecaoViewHistoricoEscolar.TabelaHistoricoTodosAnosEJA;
            TabelaAnoAtual = SecaoViewHistoricoEscolar.TabelaAnoAtualEJA;
        }

        protected override int ObterQuantidadeLinhaDadosHistorico(HistoricoEscolarEJADto historicoEscolar)
        {
            var linhas = 0;
