...
namespace SME.SR.Infra
{
    public interface IServicoTelemetria
    {
        ...
        dynamic RegistrarComRetorno<T>(Func<object> acao, string acaoNome, string tipo, string subTipo, string telemetriaNome, string telemetriaValor, string parametros = "");
        void Registrar(Action acao, string acaoNome, string telemetriaNome, string telemetriaValor);
        void Registrar(Action acao, string acaoNome, string tipo, string subTipo, string telemetriaNome, string telemetriaValor);
