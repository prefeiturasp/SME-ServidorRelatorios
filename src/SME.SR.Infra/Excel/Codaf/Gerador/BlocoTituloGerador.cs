...
namespace SME.SR.Infra.Excel.Codaf.Gerador
{
    public class BlocoTituloGerador : IBlocoTituloGerador
    {
        ...
        public int Processar(IXLWorksheet sheet, int linhaInicial, object dados)
        {
            ...
            CriarLinhaTitulo(sheet, 4, "CONTROLE DE DOCUMENTAÇÃO DAS AÇÕES FORMATIVAS - CODAF");
            CriarLinhaTitulo(sheet, 5, "RELATÓRIO DE CONCLUSÃO DE TURMA - MODELO 2025 - REDE DIRETA");
