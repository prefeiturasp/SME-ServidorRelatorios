...
namespace SME.SR.Infra
{
    public class VariaveisAmbiente
    {
        ...
        public string ConnectionStringSgpConsultas => !string.IsNullOrEmpty(configuration.GetSection("ConnectionStrings:SGP_PostgresConsultasHml2").Value) ?
            configuration.GetSection("ConnectionStrings:SGP_PostgresConsultasHml2").Value : 
            Environment.GetEnvironmentVariable("ConnectionStrings__SGP_PostgresConsultasHml2");
