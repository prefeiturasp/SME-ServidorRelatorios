...
{
    public class GraficoBarrasPAPVerticalEixoYDto
    {
        public GraficoBarrasPAPVerticalEixoYDto(decimal valorTotalAltura, string titulo, int valorMaximoEixo, int divisoesDoEixo)
        {
